...
X_train = train[['engine_capacity', 'horse_power', 'top_speed', 'cylinder']]
y_train = train['price']

X_val = validation[['engine_capacity', 'horse_power', 'top_speed', 'cylinder']]
y_val = validation['price']

X_test = test[['engine_capacity', 'horse_power', 'top_speed', 'cylinder']]
y_test = test['price']
